...
const DetailsCard = () => {
    ...
    return (
        <div>
            <div className='px-1-3 pt-1-4 lg:pb-2-8 lg:pt-3-6 lg:px-6-9 overflow-hidden lg:rounded-2xl bg-white shadow-2xl'>
                ...
                <div className=''>
                    {detailsItem.map((item, index) => {
                        return <div key={index} className={['flex justify-between items-start lg:justify-start lg:items-center py-1-4 lg:py-0-1 lg:h-3-7 text-black  border-trans-line text-1-5', index !== detailsItem.length - 1 ? 'border-b' : ''].join(" ")}>
